...
interface DynamicRuleApi {
  ...
  updateDynamicRules(options: { removeRuleIds?: number[]; addRules?: HeaderRule[] }): Promise<void>
}

function dnr(): DynamicRuleApi {
  return (browser as unknown as { declarativeNetRequest: DynamicRuleApi }).declarativeNetRequest
}

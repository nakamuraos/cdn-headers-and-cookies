...
import { panelSupported } from "@/Background/surface"
...
import type { CdnPresetId, CustomHeader, Settings, Skin, Surface, ThemePreference } from "@/types"
...
function GlobalHeaders({
  ...
  return (
    <div className='flex flex-col gap-1.5'>
      ...
      <div>
        <Button onClick={() => onChange([...headers, { name: "", value: "", enabled: true }])}>
          Add header
        </Button>
      </div>
    </div>

...
const variants: Record<Variant, string> = {
  default: "border-line-strong bg-surface text-ink px-2.5 py-1 hover:bg-surface-3",
  primary: "border-accent bg-accent text-accent-ink px-2.5 py-1 hover:brightness-110",
